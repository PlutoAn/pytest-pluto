...
def step_2(username, nickName, departmentId, sysRoleId, oneCartoon, certificateType,
...
class TestUserRegister():
    ...
    def test_register_user(self, username, login_fixture, nickName, departmentId, sysRoleId, oneCartoon,
        ...
        step_2(username, nickName, departmentId, sysRoleId, oneCartoon, certificateType, certificateNum, phone,
               email, password, confirmPassword, userType)
