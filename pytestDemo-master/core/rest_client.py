...
class RestClient():
    ...
    def request_log(self, url, method, data=None, json=None, params=None, headers=None, files=None, cookies=None,
        ...
        # print(logger.info("请求时间==>> {}".format(time.strftime('%Y-%m-%d', time.localtime(time.time())))))
        ...
        logger.info("接口请求体 data 参数 ==>> {}".format(complexjson.loads(complexjson.dumps(data, indent=4, ensure_ascii=False))))
