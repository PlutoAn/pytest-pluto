...
for i in range(start_num, end_num):
    username = "huangan" + str(i)
    nickname = str(fakerE.name())
    ps = faker1.password()
    md5 = hashlib.md5()
    ...
    try:
        cursor.execute(sql, (id, creator, modifier, create_time, update_time, deleted, remark, username, password, one_card_id,
            nickname, email, phone, type, status, role_name, gender, id_card))
